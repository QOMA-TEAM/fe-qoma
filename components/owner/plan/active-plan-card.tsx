    ...
    <div className="w-[300px] shrink-0">
      <PlanCard
        ...
        features={[
          {
            ...
            text: activeSub.plan.batas_outlet === 'Unlimited'
              ? 'Unlimited Outlet'
              : `${activeSub.plan.batas_outlet} Outlet`
          },
          {
        ...
        actionButton={
          <button
            disabled
            className="w-full text-sm font-semibold py-3 px-4 rounded-xl border border-gray-300 text-gray-700 bg-transparent"
          >
